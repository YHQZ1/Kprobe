...
- Four topics: `kernel.tcp`, `kernel.sched`, `kernel.syscall`, `kernel.fault`
- One enriched topic: `kernel.enriched` (Vector output)
...
- Routes enriched events to both ClickHouse and `kernel.enriched`
